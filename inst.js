(function(root) {
  ...
  var createInst = function(wtype, param, resv1, resv2, pitch_fs, pitch_org, data, loop_top, loop_end) {
	return new Inst(wtype, param, resv1, resv2, pitch_fs, pitch_org, data, loop_top, loop_end);
  };
  root.muslib.createInst = createInst;
  ...
  root.muslib.presetInst = presetInst;
  
  root.muslib.Inst = Inst;
