...
function MDevice(fs, ch) {
    ...
    this.IBASE0 = 43008 + inst.inst.PITCH440 - 69 * 256 + 60 * 256;
...
MDevice.prototype.setEnvSpeed = function (n) {
    return gexp.gexp(n * 192 + 4 * 12 * 256) << this.VOLS;
};
...
MDevice.prototype.setVibSpeed = function (n) {
    return gexp.gexp(n * 192 + 8 * 12 * 256);
};
